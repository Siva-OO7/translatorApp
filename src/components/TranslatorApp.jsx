...
const TranslatorApp = ( {onClose} ) => {
  ...
  return (
    <div className="w-full flex flex-col gap-y-4 items-center px-6 sm:px-8 pt-12 pb-6 relative">
        <button className="absolute top-4 right-4" onClick={onClose}>
            <i className="fa-solid fa-xmark text-xl text-gray-300"></i>
        </button>
        <div className="w-full min-h-20 flex justify-center items-center px-4 
        bg-gradient-to-r from-[#b6f492] to-[#338b93] text-gray-700 rounded-lg">
            ...
            <i 
              ...
              onClick={ handleSwapLanguages } ></i>
            <div className="language" onClick={ () => handleLanguageClick('to')} >{languages[selectedLanguageTo] || 'English'  }</div>
        </div>
        {/* w-[calc(100%-4rem)] h-[calc(100%-9rem)] bg-gradient-to-r from-[#b6f492] to-[#338b93] absolute top-32 left-8 z-10 rounded shadow-lg p-4 */}

        {showLanguages && (
        <div
          className="absolute w-[calc(100%-4rem)] h-[calc(100%-9rem)] bg-gradient-to-r from-[#b6f492] to-[#338b93] top-32 left-8 z-10 rounded shadow-lg p-4 overflow-y-scroll scrollbar-hide"
          ref={dropdownRef}
        >
            <ul>
        ...
        <div className="relative w-full" >
            <textarea 
               className="text-area text-gray-200"
               value={inputText || "" } 
        ...
        <div className="w-full">
            <textarea 
               className="text-area text-[#b6f492]"
